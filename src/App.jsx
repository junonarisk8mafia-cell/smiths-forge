...
function CareerTab() {
  const path = [
    { level:'ENTRY', icon:'🛡️', color:'#888', title:'Legal Entry Pack',
      ...
      items:['Press Machine Safety (プレス機械特別教育) — 1 day ¥10k',
             'Grinding Machine Safety (研削盤特別教育) — 1 day ¥10k',
             'Low-Voltage Electrical (低圧電気取扱特別教育) — 1 day ¥15k',
             'Full Harness Safety (フルハーネス特別教育) — 1 day ¥10k',
             'Forklift License (フォークリフト技能講習) — 3 days ¥45k'],
      note:'Legally required before touching any machine in Japan.' },
    { level:'BEGINNER', icon:'⚙️', color:'#E85D04', title:'Machine Operator',
      jp:'機械オペレーター', salary:'¥3.5–4.5M/yr',
      items:['NC/CNC machine operation basics',
             'Reading engineering drawings (図面読解)',
             'Basic quality inspection (自主検査)',
             '機械加工技能士3級 (Machining Skills Test Grade 3)'],
      note:'Your first step as a certified machinist in Japan.' },
    { level:'SKILLED', icon:'🔧', color:'#1E90FF', title:'Multi-Machine Operator',
      jp:'多能工', salary:'¥4–6M/yr',
      items:['機械加工技能士2級 (Machining Skills Test Grade 2)',
             'Lathe + milling + grinding operation',
             'Tolerance measurement (公差管理)',
             'Setup and changeover (段取り / Dandori)'],
      note:'Operating multiple machine types is the mark of a true craftsman.' },
    { level:'ADVANCED', icon:'🖥️', color:'#1565C0', title:'CNC Programmer / CAD Operator',
      jp:'CNCプログラマー/CADオペレーター', salary:'¥5–7M/yr',
      items:['機械加工技能士1級 (Machining Skills Test Grade 1)',
             'G-code / CAM programming (Gコード・CAMソフト)',
             '2D CAD: AutoCAD, JW-CAD (図面作成)',
             '3D CAD basics: SolidWorks, Fusion 360',
             'Process planning (工程設計)',
             'CAD技術者試験2級 (CAD Technician Test Grade 2)'],
      note:'Bridges the shop floor and the design office.' },
    { level:'EXPERT', icon:'🗜️', color:'#F97316', title:'Design Engineer / Die & Mold Maker',
      jp:'設計技術者/金型師', salary:'¥6–9M/yr',
      items:['金型製作技能士 (Die & Mold Skills Certification)',
             'CAD技術者試験1級 (CAD Technician Test Grade 1)',
             '3D CAD full design: SolidWorks / CATIA / NX',
             'Product design and drawing creation (製品設計・図面作成)',
             'Precision machining to ±0.001mm',
             'EDM operation (放電加工)'],
      note:'Most respected specialty in Japanese manufacturing.' },
    { level:'ELITE', icon:'📊', color:'#06B6D4', title:'Quality / Production Engineer',
      jp:'品質・生産技術エンジニア', salary:'¥7–10M/yr',
      items:['QC検定2級/1級 (Quality Control certification)',
             'ISO 9001 internal auditor',
             'Production process design (生産技術)',
             'Six Sigma / Lean manufacturing',
             'Factory-wide quality and efficiency management'],
      note:'Oversees quality and efficiency across the entire factory.' },
    { level:'LEGEND', icon:'🏆', color:'#DC2626', title:'Manufacturing Director',
      jp:'製造部長/工場長', salary:'¥10–15M/yr',
      items:['Factory manager level',
             'P&L responsibility',
             'Multi-site management',
             'Rare foreign worker achievement in Japan',
             'Path: Technical Intern → Skilled Worker → Engineer → Manager'],
      note:'The absolute pinnacle of a manufacturing career in Japan.' },
  ]
  return (
    <div style={{ padding:16, fontFamily:'monospace', background:'#0d0d0d', minHeight:'100vh', paddingBottom:70 }}>
      ...
      <div style={{ color:'#444', fontSize:'0.65rem', marginBottom:16 }}>
        Japanese Metal Fabrication Career Path — Entry to Legend
      </div>
      {path.map((s, i) => (
        <div key={i}>
